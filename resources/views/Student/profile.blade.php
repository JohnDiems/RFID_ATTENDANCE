            ...
            <div class="card m-0">
                <div class="row d-flex justify-content-center">
                    <div class="row z-depth-3">
                        ...
                        <div class="col-sm-4 rounded-left" style="background-color: #337AB7;" >
                            <!--------------------------PHOTO---------------------------->
                            <div class="card-block text-center text-white mt-5">
                                ...
                                <a href="#" style="color: red;"><i class="far fa-edit fa-2x mb-4"></i></a>
                            </div>
                        </div>
                        <div class="col-sm-8 ">
                            <h2 class="mt-5 text-center" style="color: #337AB7; font-weight: 700">INFORMATION</h2>
                            <hr class="bg-primary mt-0 w-24">
                            <div class="row">
                                <!--------------------------RFID CODE---------------------------->
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">STUDENT RFID</label>
                                    <input type="text" class="form-control form-control-lg text-center" value="{{$profiles->StudentRFID}}" disabled/>
                                </div>
                    
                                <!--------------------------COMPLETE ADDRESS---------------------------->
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">EMAIL ADDRESS</label>
                                    <input type="text" class="form-control form-control-lg text-center" value="{{$profiles->EmailAddress}}" disabled/>
                                </div>
                            
                                <!--------------------------YEAR LEVEL---------------------------->
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">GRADE LEVEL</label>
                                    <input type="text" class="form-control form-control-lg text-center" value="{{$profiles->YearLevel}}" disabled/>
                                </div>
                                
                                <!--------------------------COURSE---------------------------->
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">SECTION</label>
                                ...
                                <!--------------------------GENDER---------------------------->
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">GENDER</label>
                                    <input type="text" class="form-control form-control-lg text-center" value="{{$profiles->Gender}}" disabled/>
                                </div>
                    
                                <!--------------------------EMAIL ADDRESS---------------------------->
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">COMPLETE ADDRESS</label>
                                ...
                                <!--------------------------COMPLETE ADDRESS---------------------------->
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">CONTACT NUMBER</label>
                                    <input type="text" class="form-control form-control-lg text-center" value="{{$profiles->ContactNumber}}" disabled/>
                                </div>
                    
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">PARENT NAME</label>
                                    <input type="text" class="form-control form-control-lg text-center" value="{{$profiles->Parent}}" disabled/>
                                </div>                                          
                            </div>
                                <!--------------------------Emergency Contact---------------------------->
                                <h2 class="mt-5 text-center" style="color: #337AB7; font-weight: 700">EMERGENCY CONTACT</h2>
                                <hr>
                            <div class="row ">
                                ...
                                <!----------------------------EMERGENCY ADDRESS------------------------------>
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">EMERGENCY ADDRESS</label>
                                ...
                                <div class="form-group col-sm-6">
                                    <label class="font-weight-bold INFORMATION">EMERGENCY NUMBER</label>
