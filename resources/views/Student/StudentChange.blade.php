            ...
            <div class=" justify-content-center align-items-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-lg text-white"
                                    style="background-color: #337AB7; float:right;">Save</button>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="Security">
                    <ul>
                        ...
                        <li>If you suspect any unauthorized activity or compromise of your account, change your password
                            immediately and notify the administrator.</li>
                    </ul>
                </div>

                <div class="UsernameandPrivacy">
                    <label>
                        <h4>Username and Privacy:</h4>
                    </label>
                    <ul>
                        ...
                        <li>If you have concerns about your account's privacy, contact the administrator for assistance.
                        </li>
                    </ul>
                </div>
