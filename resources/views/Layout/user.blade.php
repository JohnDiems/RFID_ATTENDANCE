...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark  text-dark accordion" id="accordionSidebar"
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-4 text-white">Assumption<sup
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    data-target="#collapseUtilitiesreports" aria-expanded="true"
                    aria-controls="collapseUtilitiesreports">
                    <i class="fas fa-fw fa-list"></i>
                    <span class="font-weight-bold">MANAGE ATTENDANCE</span>
                </a>
                <div id="collapseUtilitiesreports" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('StudentAttendanceRecord') }}">Regular Attendance</a>
                        <a class="collapse-item" href="{{ route('StudentLunchRecord') }}">Lunch Attendance</a>
                    </div>
                </div>
            ...
            <div id="content">
              ...
              <div class="input-group">
                ...
                <div class="input-group-append">
                  <button class="btn" style="background-color: #27B0FB; color: white;" type="button">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"
                                    style="text-transform:lowercase;">{{ $user->name }}</span>
                                <img class="img-profile rounded-circle" src="{{ asset($profiles->photo) }}"
                                    alt="Profile Photo">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('StudentChange') }}">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            {{-- <form class="dropdown-item"  method="POST" action="{{ route('logout') }}" data-toggle="modal" data-target="#logoutModal">
              @csrf
              <i class="fas fa-door-open fa-sm fa-fw mr-2 text-gray-400"></i>
              Logout
            </form> --}}
