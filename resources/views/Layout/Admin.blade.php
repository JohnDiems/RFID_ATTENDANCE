...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/Sectionlist.css') }}">
...
<body id="page-top"  >
  ...
  <!-- Page Wrapper -->
  <div id="wrapper" >
       <!-- Sidebar  BG-DARK SIDE BAR ---------------------->
   <ul class="navbar-nav sidebar sidebar-dark accordion text-dark Sd-bar" id="accordionSidebar" style="background-color: #24A9E1; ">
  <!-- Sidebar - Brand -->
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('Dashboard') }}">
    <div>
      <img class="img-profile rounded-circle" style="max-width: 60%;" src="{{asset('images/RFIDLOGO.png')}}">
    </div>
    <div class="sidebar-brand-text mx-4">Assumption<sup style="color: #e4490c; "><span >ENTRIX</sup></span></div>
  </a>
  <!-- Divider -->
  ...
  <li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{ route('studentlist') }}">Student Profile</a>
        <a class="collapse-item" href="{{route('WhiteCard')}}">Register White Card</a>
      </div>
    </div>
  </li>
    ...
    <div id="collapseSection" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{ route('SectionList') }}">Section List</a>
      </div>
    </div>
    </li>

    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilitiesreports" aria-expanded="true" aria-controls="collapseUtilitiesreports">
        <i class="fas fa-fw fa-id-card"></i>
        <span class="font-weight-bold">Manage Reports</span>
      </a>
      <div id="collapseUtilitiesreports" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item" href="{{ route('monitoring') }}">Regular Attendance</a>
          <a class="collapse-item" href="{{route('LunchAttendance')}}">Lunch Attendance</a>
        </div>
      </div>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
      ...
      <span class="font-weight-bold">Manage User</span>
    </a>
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{ route('RegistrationForm') }}">User List</a>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSchedule" aria-expanded="true" aria-controls="collapseSchedule">
      ...
      <span class="font-weight-bold">Manage Schedule</span>
    </a>
    <div id="collapseSchedule" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{route('Schedule')}}">Add Schedule</a>
        <div class="collapse-divider"></div>
      </div>
    </div>
  </li>
  ...
  <!-- Nav Item - Pages Collapse Menu -->
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAnnoucement" aria-expanded="true" aria-controls="collapseAnnoucement">
      <i class="fas fa-fw fa-inbox"></i>
      <span class="font-weight-bold">Announcement</span>
    </a>
    <div id="collapseAnnoucement" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{route('Announcement') }}">Add Announcement</a>
        <div class="collapse-divider"></div>
      </div>
    </div>
  </li>
  ...
  <!-- End of Sidebar -->
      ...
      <div id="content-wrapper" class="d-flex flex-column" style="background-color: #F8F9FC;">
        ...
        <div id="content" >
          ...
          <!-- Topbar -->
          <nav class="navbar navbar-expand navbar-light topbar mb-2 static-top"  style=" background-color: #BFDBFE;">
            ...
            <h3 style="margin-left: 20px; color:#858796"><span class="Welcome"></span></h3>
            {{-- <form class="d-none d-sm-inline-block form-inline  ml-md-5 " >
              <div class="input-group">
                <input type="text" class="form-control " placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
                <div class="input-group-append">
                  <button class="btn " style="color: white;" type="button ">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn text-white" data-dismiss="modal" style="background-color: #337AB7">Cancel</button>
            <form action="{{ route('login') }}" method="POST">
            @csrf
              <button type="submit" name="logout_btn" class="btn btn-danger text-white">Logout</button>
            </form>
          </div>
        </div>
      </div>
