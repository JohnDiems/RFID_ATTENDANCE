...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-3xl font-bold text-violet-800">Create New User</h1>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="timezone" id="timezone" 
                        ...
                        <option value="Asia/Manila" {{ old('timezone') == 'Asia/Manila' ? 'selected' : '' }}>Philippines (Asia/Manila)</option>
